...
You can create your own 360 photo 'dashboard' in HTML. If you have a bunch of panoramas, you can create drop down boxes or other controls in your dashboard that control which panorama is currently shown. This requires some knowledge of HTML and CSS, but you get the customize the look and appearnace of your dashboard.

The 360 images themselves can either be hosted on 3rd party site and embedded into your web page using an iframe, or saved locally and rendered using a JavaScript library like Panellum. 

### Embedding Panoramas from RoundMe

Many people share their 360 photos by bundling them into tours on RoundMe.com. You can also use RoundMe as a hosting platform for use on other sites, such as a custom HTML page or a web map. A free RoundMe account lets you:

- store a large number of 360 photos  
- upload images up to 10,000x5,000 pixels (which covers nearly all consumer 360 cameras)  
...
RoundMe.com offers some **paid upgrades** that can help you enhance your dashboard. 
...
The **[Privacy and White List](https://help.roundme.com/en/articles/2444359-how-do-i-use-privacy-and-white-list-tour-upgrade-password-protection-for-the-tour){target="_blank" rel="noopener"}** tour upgrade ($10) allows you to assign a password to the tour, and/or restrict which internet domains a tour can be embedded from.

The **[Pro Embed](https://roundme.com/pricing/pro-embed){target="_blank" rel="noopener"}** upgrade ($15) allows you to fine-tune the appearance and functionality of your embedded panoramas. This includes overlaying your logo, controlling whether or not the embed displays a splash screen, selecting which controls appear, abd [customizing the icons](https://help.roundme.com/en/articles/2444355-how-do-i-customize-the-hotspot-and-portal-icons){target="_blank" rel="noopener"} for hotspots and portals, etc. 

<p style="margin-left:2em;">*Tip*: normally when you embed a tour, the first panorama of the tour is whatever the "home panorama" happens to be. The Pro Embed upgrade allows you to generate an embed code for each individual panorama. This gives you the ability to embed all panoramas in a tour individually with a single tour upgrade.</p>

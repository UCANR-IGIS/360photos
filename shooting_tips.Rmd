...
![](images/hiding-behind-tree_640x480.jpg){style="margin-left:2em;"}  
*Putting your camera on timer can give you time to duck behind an object*

<div class="indented2">If there are no objects to hide behind, consider where you'll be the least distraction for the viewer. It's also possible to 'Photoshop' yourself out of a 360, although this requires special software. If you plan to digitally remove yourself from the image, make yourself as small as possible and stand in front of a surface that will be easy to clone.</div>
